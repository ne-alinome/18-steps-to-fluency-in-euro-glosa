...
- For clarity, some examples with alternatives have been splitted into
  two different entries in their table.

XXX TODO -- Corrections
...
// XXX TODO -- "stilo" is right, is was changed back:
// 48 tinta-grafo-ru      pen
//       (original says stilo,
//       but this would be also "style".)

// XXX TODO -- Credit the author of the footnotes.
// XXX TODO -- Use curved quotes.
// XXX TODO -- Use italics.
...
// XXX TODO -- Convert into a list of features.
...
// XXX TODO -- Make the table of contents automatic.
...
This is the Glosa form of the Italian word ciÃ², which means this, that. In
...
// XXX TODO -- simplify the note andd join the tables:
...
| Sti id pende a mura (Other prepositions are also possible: Pend id a/de/epi/kata mura) 
| Hang it on the wall
| Registra epi flexi disko                        | Record on to a floppy disk.
| Fe pa loka u mantela epi se.                    | She put on her coat
| Skope u programa per TV (Other prepositions would be possible, too: Skope u programa per/ex/in/a/de/epi TV) 
...
_Plu Glosa Nota_, ISSN 0265-6892: This newsletter keeps Glosa users in contact
...
| Siniora. Siniorina (Sa.)footnote:[{fecivi_note}]     | Mrs. Miss (Ms)
| Sinior (Sr.)footnote:[{ancivi_note}]                 | Mr.
| Qe?                                                  | Isn't it?
| Qe, veri?                                            | Really?
...
| frakti / fria plu nuki                        |  crack / chop the nuts
...
// XXX FIXME -- Consult:
//
// prima klasi, klasi bi(original says sekunda klasi)
...
| tri kron singu anua / di            | three times a year / day
...
| Per Glosa 1000 pe pote grafo alo dice de panto tema. 
...
| Bibe bi spatula de medika-ma bi kron singu di.     | Take two spoonfuls twice a day.
| po / pre / tem vora                                | after / before / during meals
| U maxi proxi medika-ma-bo es qo-lo?                | Where is the nearest chemist shop?
|===

// XXX TODO --
// U maxi proxi medika-ma-bo es qo-lo?
// (original says Qo-lo u maxi proxi kemi-bo?) 
// Bibe bi spatula de medika-ma bi kron singu di.
// (original says Bibe bi spatula-ple bi kron u di.) 
...
// XXX TODO --
// telefono(original says face u foni-kla) 
...
| Sera ligni te face bi semi.| saw the piece of wood in half
...
// XXX TODO --
// sera ligni te face bi semi
// (original says semi u mero ligni) 
...
| Tu debi gene tako more Glosa kogita.          | You should quickly get accustomed thinking in Glosa.footnote:[{accustomed_note}]
...
| ma-boni loka plu fi                                    | adjust the straps
...
| obe u rura konsili                                     | obey the country code
|===

// XXX TODO --

// obe u rura konsili(another suggestion: akti boni, kron
...
saw yesterday".footnote:[Note: This is a bad rule for an International
Auxiliary Language. The relative pronoun, _qi_, should be permitted, in
speech and in writing, even when its function in the sentence does not
allow it a position at the beginning of the relative clause: _Un
andro; mi pa vide [qi]; akti ..._]
...
// XXX TODO --
// loka fe-regi exklude-ra supra plu larva 
// (original says only loka exklude-ra supra plu larva)
// peti via(original says vola via) 
// apo u ponti-ceru(original says ponti-cera)
...
| Mi ne pote sto se ridi.footnote:[This sentence is supplemented and not in the original.]
...
| Tu debi tenta sti vora an.             | You must try to make him eat.
| An pa face plu kali fotografi.         | He made some beautiful photographs.
| Fe pa sti u valva.                     | She turned on the tap.
| Tu ne lice casa plu zoa.               | You must not chase the animals.
| Tu ne nece casa plu zoa                | You don't need to chase the animals
...
// XXX TODO -- Explain the changes in the original, with 2 footnotes:
//
// Tu nece sti vora an.                   You have to make him eat.
// Tu debi tenta sti vora an.             You must try to make him eat.
//
...
says "`Na pa no-memo de pak u sinapi; qi sti melankoli panto-na`".] Na
pa vora u bovi in silenti. U vita nu pa feno vaku e no-stimula. Na pa
memo plu hedo di de infanti-tem; e ko tristi-senti spira ex(original
says ...; e senti tristi.). Anti-co, na gene ma hedo ko pomi pastata;
...
perfootnote:[Original says _ko_.] metali spika; qi glisa e bali mi ex
inter navi e ripa ad-in mo metra de limo aqa; e u vasa volve
ne-ge-vulne(original says no-ge-vulne), e frakti u tea- tasa.
...
| Kron na pa veni; an pa du ki ex.     | When we arrived; he was leaving.footnote:[{leaving_note}]
