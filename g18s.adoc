= 18 Steps to Fluency in Euro-Glosa [e-book draft last modified 201811172105]
...
- "(=" --> "(" and "/" ?
- Consult Marcel about the e-mail address format.
- Consult Marcel about Gary Miller's e-mail and printing service.
