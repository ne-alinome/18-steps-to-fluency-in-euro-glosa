= 18 Steps to Fluency in Euro-Glosa [e-book draft last modified 201811191824]
...
- Fix format of "Sverige", etc. Search the original HTML version for
  bold and italic.
- Add address to postcard and fix its layout.
...
// XXX REMARK -- Add the stamp only when HTML5 is created directly by
// Asciidoctor.

image::g18s040.gif[Indian stamp,float="right"]
